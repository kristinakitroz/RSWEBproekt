...
namespace RSWEBproekt.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string title, int? semester, string studyProgram)
        {
            ...
            {
                courses = courses.Where(c => c.StudyProgram.Contains(studyProgram));
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Credits,Semester,StudyProgram,EducationLevel,FirstTeacherId,SecondTeacherId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Credits,Semester,StudyProgram,EducationLevel,FirstTeacherId,SecondTeacherId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
